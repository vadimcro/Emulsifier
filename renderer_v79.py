...
class FilmRendererApp(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
        self.title("Emulsifier Film Emulator - Rendering Engine v1.79")
    ...
    def setup_ui(self):
        ...
        self.cross_var = ctk.DoubleVar(master=self, value=20) 
        self.flat_var = ctk.DoubleVar(master=self, value=25)
        self.hal_var = ctk.DoubleVar(master=self, value=20)
        self.bloom_var = ctk.DoubleVar(master=self, value=10)
    ...
    def save_state(self):
        ...
        # +1 because the stack holds the historical states AND the current state at the top
    ...
    def update_labels(self):
        ...
        if "Calculating" not in self.lbl_str.cget("text"):
            # Ensure "Auto" tag drops off if restored state was manually adjusted
    ...
    def load_image_from_path(self, file_path):
        try:
            ...
            # Reset history stacks on new image load
