...
try:
    ...
    messagebox.showerror(
        ...
        "Emulsifier v1.86.1 requires 'numexpr' for CPU hardware acceleration.\n\n"
...
try:
    ...
    messagebox.showerror(
        ...
        "Emulsifier v1.86.1 requires 'tkinterdnd2' and 'customtkinter'.\n\n"
...
class FilmRendererApp(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
        self.base_title = "Emulsifier Film Emulator - Rendering Engine v1.86.1"
