...
try:
    ...
    messagebox.showerror(
        ...
        "Emulsifier v1.84 requires 'numexpr' for CPU hardware acceleration.\n\n"
...
class FilmRendererApp(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
        self.base_title = "Emulsifier Film Emulator - Rendering Engine v1.84"
    ...
    def confirm_reset(self):
        ...
        if messagebox.askyesno("Reset Workspace", "Are you sure you want to reset all applied settings?"):
            self.save_state() # Save complex grade to Undo Stack before destroying it
            ...
            self.ca_var.set(2)
            self.cross_var.set(20)
            self.flat_var.set(25)
            self.hal_var.set(20)
            self.bloom_var.set(10)
