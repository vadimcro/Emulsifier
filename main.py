...
class FilmRendererApp(TkinterDnD.Tk):
    ...
    def export_image(self):
        ...
        threading.Thread(target=self._export_worker, args=(save_path, export_params, export_profile_name), daemon=True).start()

    def _export_worker(self, save_path, params, export_profile_name):
        try:
