...
class FilmRendererApp(TkinterDnD.Tk):
    ...
    def setup_ui(self):
        ...
        self.pane_input = CollapsiblePane(self.scroll_frame, "Input Conditioning", app=self)
        ...
        self.lbl_input_exp = create_slider_row(
            ...
            self.pane_input,
            "Exposure Anchor",
            "Gently moves the source image toward a stable midtone before film density mapping. Uses median luminance with capped gain so low-key and high-key images keep their intent.",
            self.input_exp_var,
            0,
            100
        )
        self.lbl_input_luma = create_slider_row(
            ...
            "Analyzes robust luminance percentiles. High-contrast files are softly faded; flat files receive a mild punch before the emulsion curve.",
            self.input_luma_var,
            0,
            100
        )
        self.lbl_input_fade = create_slider_row(
            ...
            self.pane_input,
            "Source Fade",
            "Adds lifted shadows, softer contrast, weaker dye separation, and subtle aged color contamination.",
            self.input_fade_var,
            0,
            100
        )
        self.lbl_input_vib = create_slider_row(
            ...
            self.pane_input,
            "Vibrance Guard",
            "Reduces only excessive chroma, protecting normal color while taming oversaturated phone, AI, neon, sky, and red-channel-heavy files.",
            self.input_vib_var,
            0,
            100
        )
        self.lbl_input_tint = create_slider_row(
            ...
            self.pane_input,
            "Tint Guard",
            "Optional weak cast correction based on low-saturation midtones. Keep low or off when the source has intentional warm/cool atmosphere.",
            self.input_tint_var,
            0,
            100
        )
