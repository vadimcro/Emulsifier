...
try:
    ...
    messagebox.showerror(
        ...
        "Emulsifier v1.83 requires 'numexpr' for CPU hardware acceleration.\n\n"
...
try:
    ...
    messagebox.showerror(
        ...
        "Emulsifier v1.83 requires 'tkinterdnd2' and 'customtkinter'.\n\n"
...
class FilmRendererApp(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
        self.title("Emulsifier Film Emulator - Rendering Engine v1.83")
    ...
    # --- v1.83 ACCELERATED MATH PIPELINE ---
    def process_engine(self, cache, img_array, soft_amt, ca_amt, ff_amt, ff_fall, vig_amt, vig_fall, flatten_pct, 
        ...
        # --- PYRAMID BLUR (MIPMAP) ARCHITECTURE ---
        ...
        if grain_on:
            ...
            if grain > 0:
                ...
                noise = ne.evaluate("sign(noise) * (abs(noise) ** 0.8)")
                ...
                grain_mask = ne.evaluate("(luma ** 0.5) * ((1.0 - luma) ** 1.5) * 2.5")
